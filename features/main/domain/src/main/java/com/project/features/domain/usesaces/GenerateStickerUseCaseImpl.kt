package com.project.features.domain.usesaces
...
class GenerateStickerUseCaseImpl @Inject constructor(private val stickerGenerationRepository: StickerGenerationRepository): GenerateStickerUseCase {
